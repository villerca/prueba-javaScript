...
Tambien declarar es para reservar un espacio en memoria e inicializar y reinicializar es cuando guardamos informacion en ese espacio la cual podemos cambiar cuando sea el caso(reinicializar).

- ¿Cuál es la diferencia entre sumar números y concatenar strings?
- ¿Cuál operador me permite sumar o concatenar?

EL operador que nos permite sumar o concatenar es +. Este operador nos permite sumar números cuando lo usamos con números(operacion matematica). Pero cuando los que sumamos son strings, lo que hace es unir (concatenar, así se dice) ambos strings.
...
```
let nombre = 'Leo';
let apellido = 'Cruz Son';
let username = 'lcson';
let edad = 19;
let mail = 'juanito@hahoo.com';
...
```
const name = "Leo";
const lastname = "Cruz Son";
const completeName = name + lastname;
const nickname = "lcson";
